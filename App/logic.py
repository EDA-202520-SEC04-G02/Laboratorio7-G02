...
# TODO DONE Realice la importación del Árbol Binario Ordenado
from DataStructures.Tree import binary_search_tree as bst
# TODO DONE Realice la importación de ArrayList (al) como estructura de datos auxiliar para sus requerimientos
from DataStructures.List import array_list as al
# TODO DONE Realice la importación de LinearProbing (lp) como estructura de datos auxiliar para sus requerimientos
...
def new_logic():
    ...
    # TODO DONE completar la creación del mapa ordenado
...
def update_date_index(map, crime):
    ...
    if entry is None:
        # TODO DONE Realizar el caso en el que no se encuentra la fecha
